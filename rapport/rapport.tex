...
\begin{tikzpicture}[node distance=3cm]
 ...
 \draw[decorate, decoration={brace, mirror, amplitude=6pt}, red]
  (st0.south west) -- (stn.south east)
  node[midway, below=6pt, red] {zone contrainte};

\draw[decorate, decoration={brace, mirror, amplitude=6pt}, blue]
  (stn1.south west) -- (stx.south east)
  node[midway, below=6pt, blue] {zone d'évaluation hors contrainte};
...
Pour implémenter cette version hachée, nous avons utilisé la fonction de hachage \textbf{SHA-256} d’OpenSSL.
