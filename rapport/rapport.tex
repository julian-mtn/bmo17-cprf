...
Avec une telle clé contrainte, au lieu de calculer $\pi_{PK}^{\,n-c}(ST_n)$, il calculera $\pi_{PK}^{\,x-n}(ST_x) = ST_a$.
Si l'attaquant retrouve $ST_a = ST_n$, il peut alors conclure que la valeur $ST_x$ est le résultat d'une fonction non aléatoire.
