...
\[
X = (r_p * q * q^{-1}_{\bmod p} + r_q * p * p^{-1}_{\bmod q}) \bmod n 
\]

//TODO : gérer les autres racines
//dire que ça fonctionne pas car pas une permutation à trappe, en appliquant la permutation inverse n-c fois
// on n'est pas sûr que la pré-image soit celle qu'on veut

// avec AES ? 

//marche pas non plus car l'attaquant a besoin de la clé de chiffrement pour inverser la permutation
