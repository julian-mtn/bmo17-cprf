...
\[
x \equiv \pm r_p \pmod{p}, \quad x \equiv \pm r_q \pmod{q}
\]

%\subsection{Recombinaison par le théorème des restes chinois}

En combinant les solutions modulo $p$ et $q$ à l'aide du théorème des restes chinois, on obtient quatre solutions distinctes modulo $n$ :
\[
(\pm r_p, \pm r_q)
\]

Chaque paire correspond à une solution $x$ telle que :
\[
x^2 \equiv y \pmod{n}
\]
