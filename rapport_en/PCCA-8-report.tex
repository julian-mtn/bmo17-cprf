...
In Figure \ref{fig:stat4}, we observe the results of the attack we implemented on the CPRF F^{WEAK}, where we can clearly see that this attack allows gaining a significant advantage over the CPRF F^{WEAK} when it is not hashed.
