...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Mode} & \textbf{Parameters} & \textbf{Description} \\
\hline
\texttt{-n} & \texttt{<size>} & Standard CPRF, number of tests \\
\hline
\texttt{-h} & \texttt{<size>} & Hashed CPRF (SHA-256), number of tests \\
\hline
\texttt{-l} & \texttt{<size>} & Lazy sampling, number of tests \\
\hline
\texttt{-f} & \texttt{<tries> <N> <M>} & FWEAK mode: number of attempts, dimensions N and M \\
\hline
\end{tabular}
\end{center}

\subsubsection*{Display the plots}
