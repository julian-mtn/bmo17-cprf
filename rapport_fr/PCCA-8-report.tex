...
Sur la figure \ref{fig:stat4}, on observe les résultats de l'attaque qu'on a implémenter sur la cprf F^{WEAK}, où on peut bien voir que cet attaque permet de gagner un avantage significatif sur la CPRF F^{WEAK} lorsqu'elle n'est pas haché.
