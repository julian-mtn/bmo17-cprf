...
Malheureusement, cette approche échoue : le théorème de CJ25 requiert que la CPRF sous-jacente soit IND$^*$-NC-CPRF sécurisée, ce que $F^{\text{WEAK}}$ ne satisfait pas, cependant, ce n'est pas un preuve que $Hashed(F^{\text{WEAK}})$ n'est pas SIM$^*$-AC-CPRF sécurisée.
